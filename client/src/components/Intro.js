...
const Intro = () => {
  ...
  return (
    <div className=' w-3/5 bg-white rounded-md shadow-md gap-4 p-4 flex flex-col items-center justify-center'>
            ...
            <span className='text-link'>
                {categories?.length > 0 && categories.map(item => {
                    return (
                        ...
                        key={item.code} 
                        className='text-green-700 font-medium hover:text-orange-600'
                        >
